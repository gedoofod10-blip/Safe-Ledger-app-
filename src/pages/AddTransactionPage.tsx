            ...
            <div className="flex gap-3 flex-col">
              <div className="flex-1">
                ...
                <div className="flex items-start gap-2">
                  <textarea
                    className="w-full border-b-2 border-border bg-transparent px-2 py-2 text-right text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-secondary transition-colors resize-none"
                    placeholder="التفاصيل"
                    rows={4}
                    value={details}
                    onChange={e => setDetails(e.target.value)}
                  />
                  <button onClick={() => fileInputRef.current?.click()} className="flex-shrink-0 hover:opacity-70 transition-opacity mt-2">
